...
```mermaid
graph TD
    A[Superstructure: Politics, Law, Culture, Ideology] -->|Legitimizes & Maintains| B[Economic Base]
    B[Economic Base: Forces & Relations of Production] -->|Determines & Shapes| A
```
