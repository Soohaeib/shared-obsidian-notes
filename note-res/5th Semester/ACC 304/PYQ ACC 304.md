...
- (c) How the following techniques of cost accounting are used in ascertain and controlling cost:
    - i. Absorption costing **[01]**
    - ii. Marginal costing **[01]**
    - iii. Life cycle costing **[01]**
    - iv. Target costing **[01]**
    - v. Standard costing **[01]**
    - vi. Budgeting **[01]**
...
- Direct manufacturing labor: Tk. 22,000
- Direct expenses (Specialized tool hire): Tk. 5,000
- Indirect manufacturing labor: Tk. 17,000
- Plant insurance: Tk. 7,000
- Depreciation—plant, building, and equipment: Tk. 11,000
- Repairs and maintenance—plant: Tk. 3,000
- Marketing, distribution, and customer-service costs: Tk. 91,000
- General and administrative costs: Tk. 24,000
- Sales of scrap (from production): Tk. 2,000
- Profit: 25% on Sales
...
- Two pounds of direct materials are used to make one unit of finished product.
- Revenues in 2020 were Tk. 473,200.
- The selling price per unit and the purchase price per pound of direct materials were stable throughout the year.
- The company's ending inventory of finished goods is carried at the average unit manufacturing cost for 2020.
- Finished-goods inventory at December 31, 2020, was Tk. 20,970.

**Required:**
    - i. Calculate direct materials inventory, total cost, December 31, 2020. **[1.5]**
    - ii. Calculate finished-goods inventory, total units, December 31, 2020. **[2.5]**
    - iii. Calculate selling price in 2020. **[1.5]**
...
- (b) Prepare an Income Statement. **[03]**
- (c) Assume the company produced equivalent of 10,000 units of product during the year just completed. What was the average cost per unit for direct materials? What was the average cost per unit for fixed manufacturing overhead? **[03]**
...
- Write short notes on the following:
    ...
    - (c) Sunk cost and opportunity cost. **[03]**
...
- (a)
**Data:**
Pran Company made the following materials purchases and issues during January.
- Inventory: January 1. 500 units @ Tk. 12.00
- Receipts:
    - January 6: 200 units @ Tk. 12.50
    - January 10: 400 units @ Tk. 13.00
    - January 25: 500 units @ Tk. 14.00
- Issues:
    - January 15: 560 units
    - January 27: 400 units.

**Required:** Compute the cost of materials consumed and the cost assigned to the inventory at the end of the month, using the perpetual inventory system and:
- i. Average costing. **[2.5]**
- ii. FIFO costing. **[2.5]**
- (b)
**Data:**
...
- (c)
**Data:**
Evan Company has developed the following costs and other data pertaining to one of its raw materials:
- Normal use per day: 400 units
- Maximum use per day: 600 units
- Minimum use per day: 100 units
- Working day per year: 250
- Lead time: 8 days
- Cost of placing an order: Tk. 20.00
- Cost per unit of material: Tk. 2.50
- Carrying cost percentage: 10%

**Required:** Compute the following:
- i. Economic order quantity. **[01]**
- ii. Safety stock. **[01]**
- iii. Reorder point. **[01]**
...
> - Insurance, space, materials-handling, and setup costs, which currently total $400,000 annually, would decline by 20%.
...
- (a)
**Data:**
M/s Tubes Ltd. are the manufacturers of picture tubes for T.V. The following are the details of their operation during the year 2024:
...
- Details of lead time: Average: 10 days, Maximum: 15 days, Minimum: 5 days. For emergency purchases: 4 days.
- Rate of consumption: Average: 15 units per day, Maximum: 20 units per day.

**Required:** Compute from the above:
- i. Re-ordering level
- ii. Maximum level
- iii. Minimum level
- iv. Danger level
- v. Re-order quantity **[06]**
- (b)
**Data:**
...
- (c)
**Data:**
Maxim Limited manufactures a special product "Zed". The following particulars were collected for the current year:
...
- Maximum usage: 125 units per week.
- Minimum usage: 65 units per week.
...
- Dec 1: Opening balance 500 units @ Rs.25 per unit
- Dec 3: Issue 70 units
- Dec 4: Issue 100 units
- Dec 8: Issue 80 units
- Dec 13: Received from supplier 200 units @ Rs.24.50 per unit
- Dec 14: Returned to store 15 units @ Rs.24 per unit
- Dec 16: Issue 180 units
- Dec 20: Received from supplier 240 units @ Rs.24.75 per unit
- Dec 24: Issue 304 units
- Dec 25: Received from supplier 320 units @ Rs.24.50 per unit
- Dec 26: Issue 112 units
- Dec 27: Returned to store 12 units @ Rs.24.50 per unit
- Dec 28: Received from supplier 100 units @ Rs.25 per unit
- Shortages revealed:
    - December 15th: shortage of 5 units
    - December 27th: shortage of 8 units.
...
- (b)
**Data:**
Myler Tubes Limited are the manufacturer of picture tubes of Television. The following are the details of the operations during the current year:
- Average monthly market demands: 2,000 tubes
- Ordering cost: $100 per order
- Inventory carrying cost: 25% per annum
- Cost of tube: $400 per tube
...
- i. Economic order quantity. If the supplier is willing to supply quarterly 1,300 units at a discount of 5 per cent, is it worth accepting?
- ii. Maximum stock level.
- iii. Minimum stock level and
- iv. Reorder level. **[06]**
- (c)
**Data:**
...
- (a) An employee working under a bonus scheme saves 4 hours in a job for which the standard time is 32 hours. Calculate the rate per hour worked and wages payable for the time taken under the following alternative schemes. (Award rate Tk. 1/- per hour)
    ...
    - ii. A bonus of 10 per cent on award rate is payable when standard time (namely, 100 per cent efficiency) is achieved plus a further bonus of 1 per cent on award rate for each 1 per cent in excess of that 100 per cent efficiency. **[05]**
- (b)
**Data:**
...
- (c)
**Data:**
The HRM department of a company gives you the following information regarding labor:
- Number of workers on the payroll at the beginning of the month: 1,900
- Number of workers on the payroll at the end of the month: 2,100
- During the month 20 persons quit while 80 persons are discharged.
...
> The company employs 10 workers on an 8-hour shift at $8 per hour. Depreciation on plant equipment is $9 per hour, and other overhead is applied at $7 per hour. Production for the first week under 100 percent group bonus plan was:
> - Monday: 3,800 units
> - Tuesday: 4,500 units
...
- (c) What will be the earnings of a worker at $7.50 per hour when he takes 140 hours to do a volume of work for which the standard time allowed is 200 hours? The plan of payment of bonus is on a sliding scale as under:
    - Within the first 20% of savings in standard time, bonus is 30% of time saved.
    - Within the second 10% of savings in standard time, bonus is 40% of time saved.
    - Within the third 40% of savings in standard time, bonus is 50% of time saved.
...
- ii. Actual production during the month: A: 1,700 units; B: 1,500 units; C: 1,900 units.
- iii. Piece work rate is taka 0.05 per unit
- iv. Additional production bonus is taka 10 for each percentage of actual production exceeding 80% actual production over standard (e.g., 79% nil, 81% taka 10, 82% taka 20, and so on).
- v. Fixed dearness allowance: taka 100 per month. **[05]**
- (d)
**Data:**
...
- (b)
**Data:**
Standard production for an employee in the Assembly Department is 20 units per hour in an 8-hour day. The hourly wage rate is $10.
...
- Direct wages: TK 30,000
- Direct labor hours worked: 25,000 hours
- Hours of machine operation: 20,000 hours
- Overheads chargeable to the department: TK 25,000

If the cost of materials consumed on Job No. 253 is TK 2,000 and labor cost amount to TK 1,650, ascertain the production cost by the following methods of allocating overheads:
- i. Percentage on direct wages
- ii. Machine hour rate
- iii. Direct labor hour rate
...
- (b)
**Data:**
XYZ company has decided to distribute the cost of service departments by algebraic method. The production departments are Department A and Department B. The service departments are Boiler house and Pump room. The monthly data are:

*Annual factory overhead cost before distribution:*
- Department A: $200,000
- Department B: $350,000
- Boiler house: $300,000
- Pump room: $60,000
...
- ii. Re-apportion the costs of service department to the production departments based on 7:8:5.
- iii. Ascertain the overhead rates per hour for the production department. **[08]**
- (b)
**Data:**
...
**Requirements:**
- i. Apportion the expenses among the various departments by the most equitable method.
- ii. Re-apportion the costs of service department to the production departments based on 6:4:3.
- iii. Ascertain the rates per hour for the production department. **[08]**
- (b)
**Data:**
A factory has three production departments and two service departments. The following is the summary of primary distribution of overheads:
...
**Required:**
- i. Calculate the total cost for job A. **[02]**
...
- **According to BCAS-7:**
    ...
    - (b) Draw a chart of flow of documents required in job order costing system. **[05]**
...
**Requirements:**
- i. Enter the appropriate information on a Job order cost sheet.
- ii. Determine the sales price of the job, assuming that it was contracted with a markup of 40% of cost. **[04]**
- (c)
**Data:**
Hellman Corporation uses job order costing and has two production departments, M and A. Budgeted manufacturing costs for 2022 were as follows:
...
*On the basis of this information, prepare cost sheet showing the production and setting up cost, both in total and per component, assuming a batch of:*
    - i. 10 components
    - ii. 100 components
    - iii. 1,000 components is produced. **[06]**
